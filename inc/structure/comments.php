...
if ( ! function_exists( 'neckbeard_comment' ) ) {
	...
	function neckbeard_comment( $comment, $args, $depth ) {
		...
		<div class="comment-meta commentmetadata">
			...
			<?php printf( __( '<cite class="fn">%s</cite>', 'neckbeard' ), get_comment_author_link() ); ?>
			</div>
			<?php if ( '0' == $comment->comment_approved ) : ?>
				<em class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'neckbeard' ); ?></em>
				<br />
			<?php endif; ?>
		...
		<?php edit_comment_link( __( 'Edit', 'neckbeard' ), '  ', '' ); ?>
		</div>
		</div>
		<?php if ( 'div' != $args['style'] ) : ?>
		</div>
