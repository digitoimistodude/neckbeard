 ...
 * @since 1.0
 */
if ( ! function_exists( 'neckbeard_add_integrations_customizer_css' ) ) {
	function neckbeard_add_integrations_customizer_css() {

		if ( is_neckbeard_customizer_enabled() ) {
			$accent_color 					= neckbeard_sanitize_hex_color( get_theme_mod( 'neckbeard_accent_color', apply_filters( 'neckbeard_default_accent_color', '#96588a' ) ) );
			$header_text_color 				= neckbeard_sanitize_hex_color( get_theme_mod( 'neckbeard_header_text_color', apply_filters( 'neckbeard_default_header_text_color', '#9aa0a7' ) ) );
			$header_background_color 		= neckbeard_sanitize_hex_color( get_theme_mod( 'neckbeard_header_background_color', apply_filters( 'neckbeard_default_header_background_color', '#2c2d33' ) ) );
			$text_color 					= neckbeard_sanitize_hex_color( get_theme_mod( 'neckbeard_text_color', apply_filters( 'neckbeard_default_text_color', '#60646c' ) ) );
			$button_background_color 		= neckbeard_sanitize_hex_color( get_theme_mod( 'neckbeard_button_background_color', apply_filters( 'neckbeard_default_button_background_color', '#60646c' ) ) );
			$button_text_color 				= neckbeard_sanitize_hex_color( get_theme_mod( 'neckbeard_button_text_color', apply_filters( 'neckbeard_default_button_text_color', '#ffffff' ) ) );
			...
			wp_add_inline_style( 'neckbeard-style', $woocommerce_style );
